...
countyname = "Broward"    # Critical to have this!
...
def getResults():
    ...
    html = urllib.request.urlopen("https://enr.electionsfl.org/BRO/1897/Summary/")
    bsObj = BeautifulSoup(html, "html5lib")
    detailedResults = bsObj.find("option", {"value":"detailed"})
